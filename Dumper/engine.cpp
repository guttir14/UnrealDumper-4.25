...
struct {
  ...
  { //PromodClient-Win64-Shipping
    &Default,
    {"\x48\x8D\x0D\x00\x00\x00\x00\xE8\x00\x00\x00\x00\xC6\x05\x00\x00\x00\x00\x01\x0F\x10\x03\x4C\x8D\x44\x24\x20\x48\x8B\xC8",30},
    {"\x48\x8B\x15\x00\x00\x00\x00\x0F\x1F\x44\x00\x00",12},
    nullptr
  }, 
  { //Dauntless-Win64-Shipping
    &Default,
	{"\x48\x8d\x0d\x00\x00\x00\x00\xe8\x00\x00\x00\x00\xc6\x05\x00\x00\x00\x00\x00\x0f\x10\x03", 22},
	{"\x48\x8B\x05\x00\x00\x00\x00\xC1\xF9", 9},
	nullptr
  },
  { //SquadGame
    &Squad,
    {"\x4C\x8D\x05\x00\x00\x00\x00\xEB\x16\x48\x8D\x0D\x00\x00\x00\x00\xE8\x00\x00\x00\x00", 22},
    {"\x48\x8D\x1D\x00\x00\x00\x00\x8B\x05\x00\x00\x00\x00\x39\x45\x88\x7C\x20\x48\x8D\x45\x88\x48\x89\x85\x90\x05\x00\x00", 30},
    nullptr
  },
  { // Mordhau
    &Default,
...
std::unordered_map<std::string, decltype(&engines[0])> games = {
  ...
  {"Mordhau-Win64-Shipping", &engines[14]},
};
